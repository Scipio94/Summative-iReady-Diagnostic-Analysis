# Grade Level Proficiency SQL Syntax
...
/*Combining all CTEs into single dataset*/
  SELECT
  ir1.iReady_Index,ir1.Student_Grade,ir1.Proficiency,ir1.Proficiency_Count,ir1.ir1_Grade_Proficiency_Percentage AS Percentage,Total
FROM ir1 --iReady 1 Data
UNION ALL
SELECT
  ir2.iReady_Index,ir2.Student_Grade,ir2.Proficiency,ir2.Proficiency_Count,ir2.ir2_Grade_Proficiency_Percentage AS Percentage, Total
